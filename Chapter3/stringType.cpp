...
int main() {
    ...
    // creates a string 
    const std::string hexadigits("123456789ABCDEF");
    // console output
    std::cout << "Please enter a series of number between 0 and 15"
              << " sperated by spaces.\nit ENTER when you are done\n"
              << std::endl;
    // use to hold the result of the loop
    std::string result;
    //
